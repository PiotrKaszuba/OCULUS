...
if __name__ == "__main__":
    ...
    repo_base = "../Images/"
    repo_name = "all"
    new_name = "TarczaValidate"

    shared_mask_data_filename = 'maskDataTest100.csv'
    ...
    obj = br.BuildRepo(repo_base, repo_name, new_name, level, scale, lambda x: x, onlyMasked, override)
    obj.Build()
